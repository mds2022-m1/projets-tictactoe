...
<div class="flex justify-center items-center bg-[url('$lib/images/background.png')]" />
<div
	class="flex flex-col items-center justify-center w-1/2 h-1/2 bg-gray-100 rounded-lg shadow-2xl"
>
	{#if result !== 'PROGRESS'}
		{#if result === 'WIN'}
